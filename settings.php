...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtextarea('tiny_multilang2/highlight_css',
        get_string('highlightcss', 'tiny_multilang2'), get_string('highlightcss_desc', 'tiny_multilang2'), $multilang2_default_css, PARAM_RAW));
}
